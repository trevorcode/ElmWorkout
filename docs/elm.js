...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aI, request.R, true);
		} catch (e) {
...
var $author$project$Main$GotText = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{ay: false, aA: r.aA, K: r.K, Y: r.Y, aI: r.aI, aT: r.aT, as: r.as, R: r.R}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aA: $elm$http$Http$emptyBody, K: r.K, Y: _List_Nil, aI: 'GET', aT: $elm$core$Maybe$Nothing, as: $elm$core$Maybe$Nothing, R: r.R});
};
		...
		$elm$http$Http$get(
			{
				K: $elm$http$Http$expectString(
					$author$project$Main$GotText(1)),
				R: 'workouts/' + ($elm$core$String$fromInt(1) + '.txt')
			}));
};
		...
		switch (msg.$) {
			...
			case 0:
				...
				if (!result.$) {
					...
					return _Utils_eq(model.I, $author$project$Main$Loading) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{I: $author$project$Main$Failure}),
...
var $author$project$Main$LoadWorkout = function (a) {
	return {$: 3, a: a};
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$ToggleWorkout),
				...
				switch (_v0.$) {
					case 0:
						return $elm$html$Html$text('I was unable to load your workout.');
					case 1:
				...
				_List_fromArray(
					[
						...
						$author$project$Main$LoadWorkout(1))
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick(
						$author$project$Main$LoadWorkout(0))
					]),
				_List_fromArray(
					[
